...
contract MockStork is IStork {
    ...
    function setPrice(bytes32 id, int192 value, uint64 timestampNs) external {
        _values[id] = StorkStructs.TemporalNumericValue({
    ...
    function updateTemporalNumericValuesV1(
        StorkStructs.TemporalNumericValueInput[] calldata
    ...
    function getTemporalNumericValueV1(
        bytes32 id
    ) external view override returns (StorkStructs.TemporalNumericValue memory) {
