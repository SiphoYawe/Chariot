  ...
  return (
    <section className="py-20 bg-[#F8FAFA]">
      <div className="max-w-[1200px] mx-auto px-8">
        <h2 className="text-center text-sm font-medium uppercase tracking-wider text-[#6B8A8D] mb-10">
        ...
        <div className="flex items-center justify-center gap-6 mb-10">
          {partners.map((partner) => (
            ...
            >
              <span className="text-sm font-semibold text-[#023436]">
                {partner.name}
              </span>
            </div>
          ))}
        </div>
        <p className="text-center text-sm text-[#6B8A8D] max-w-[680px] mx-auto leading-relaxed">
