...
import { IconCircleCheckFilled, IconLoader2, IconLockFilled } from "@tabler/icons-react";
  ...
  if (state === "approved") {
    return (
      <div className="flex items-center gap-2 p-3 bg-[#03B5AA]/10 border border-[#03B5AA]/20">
        <IconCircleCheckFilled size={16} className="text-[#03B5AA]" />
  ...
  if (state === "approving") {
    return (
      <div className="flex items-center gap-2 p-3 bg-[#F8FAFA] border border-[rgba(3,121,113,0.15)]">
        <IconLoader2 size={16} className="text-[#03B5AA] animate-spin" />
